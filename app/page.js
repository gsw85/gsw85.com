              ...
              <div className="mt-6 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
                ...
                >
                  <svg
                    ...
                    fill="currentColor"
                    className="h-5 w-5 mr-2 text-sky-500 hover:text-sky-600 fill-current"
                    viewBox="0 0 16 16"
                  >
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="h-5 w-5 mr-2 text-black hover:text-gray-700 fill-current"
                    viewBox="0 0 16 16"
                  >
                ...
                >
                  <svg
                    ...
                    height="16"
                    fill="currentColor"
                    className="h-5 w-5 mr-2 text-cyan-600 hover:text-cyan-900"
                    viewBox="0 0 16 16"
                  >
                ...
                <a
                  href="https://play.gsw85.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  <RocketLaunchIcon className="h-5 w-5 mr-2 text-red-500 hover:text-red-600" />
                </a>
              </div>
            </div>
          </main>
